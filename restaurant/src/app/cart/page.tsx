...
//       </div>
//       {/* Payment Container */}
//       <div className='h-1/2 p-4 bg-fuchsia-50 flex flex-col gap-4 justify-center text-red-500 lg:flex-row'>
...
//           <span className='text-green-700'>$81.88</span>
//         </div>
...
const CartPage = () => {
  return (
    <div className="h-[calc(100vh-6rem)] md:h-[calc(100vh-9rem)] flex flex-col text-red-500 lg:flex-row">
      {/* PRODUCTS CONTAINER */}
      <div className="h-1/2 p-4 flex flex-col justify-center overflow-scroll gap-4 lg:h-full lg:w-2/3 2xl:w-1/2 lg:px-20 xl:px-40 2xl:text-xl 2xl:gap-6 sm:">
        {/* SINGLE ITEM */}
